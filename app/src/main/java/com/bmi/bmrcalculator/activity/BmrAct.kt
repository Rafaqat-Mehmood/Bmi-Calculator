...
import com.bmi.bmrcalculator.activity.Dashboard.Companion.genderStr
import com.bmi.bmrcalculator.databinding.ActivityBmrBinding
...
// Weight Units
            ...
            nextBtn.setOnClickListener {
                var bmr = calculateBMR(genderStr, weightInput.editText?.text.toString().toDouble(),
                    heightInput.editText?.text.toString().toDouble(), ageValue)
